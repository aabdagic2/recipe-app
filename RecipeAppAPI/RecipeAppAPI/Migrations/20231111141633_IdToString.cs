    ...
    public partial class IdToString : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TokenValidities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    recipeUri = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodHistory_AppUsers_appUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PastMessages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PastMessages_AppUsers_appUserId",
                        column: x => x.appUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodHistory_appUserId",
                table: "FoodHistory",
                column: "appUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PastMessages_appUserId",
                table: "PastMessages",
                column: "appUserId");
